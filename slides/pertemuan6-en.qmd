...
I used Claude Code (Model Opus 5 and Sonnet 5) to brainstorm material, produce figures, search for references, and troubleshoot `quarto` and `git` code. I take full responsibility for the substance and presentation of these slides.
:::
