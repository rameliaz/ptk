...
1. Dua rumusan tujuan pembelajaran
2. Definisi taksonomi dan tujuan instruksional
3. Taksonomi Bloom dan revisinya
4. 6️⃣ level proses kognitif
5. Dimensi pengetahuan
6. Tabel dua dimensi dan kaitannya dengan *blueprint*
7. Merumuskan tujuan instruksional
8. Kata kerja yang tidak dapat diamati
9. Aktivitas: mengklasifikasikan tujuan instruksional

# 2️⃣ rumusan tujuan pembelajaran {background-color="#14497F" .center}
...
::: {.incremental}
* [Anderson dan Krathwohl (2001)](https://books.google.de/books/about/A_Taxonomy_for_Learning_Teaching_and_Ass.html?hl=de&id=EMQlAQAAIAAJ&redir_esc=y) merevisi taksonomi ini bersama sekelompok peneliti pendidikan, kognisi, kurikulum, dan pengukuran.
...
3. *"Mahasiswa dapat menyusun *blueprint* tes untuk konstruk yang ditentukan."*
:::
...
2. Taksonomi Bloom (1956) memakai enam kategori berupa kata benda; revisi [Anderson dan Krathwohl (2001)](https://books.google.de/books/about/A_Taxonomy_for_Learning_Teaching_and_Ass.html?hl=de&id=EMQlAQAAIAAJ&redir_esc=y) mengubahnya menjadi kata kerja dan menukar urutan dua level tertinggi.
