...
(A) Anting : Telinga <br> (B) Sarang : Burung <br>　(C) Sayur : Panci <br> (D) Kuas : Cat
...
(A) Semua melati memiliki putik <br> (B) Sebagian melati tidak memiliki putik <br> (C) Sebagian bunga bukan melati <br> (D) Semua bunga adalah melati
...
* Opsi jawaban ada yang ditulis terlalu panjang.
:::

## Ringkasan

::: {.incremental}
1. Item pilihan ganda terdiri atas *stem*, *key*, dan *distractors*, dan masing-masing punya fungsi dan prinsip penulisan tersendiri.
