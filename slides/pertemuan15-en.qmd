...
I used Claude Code (Model Sonnet 5) for *brainstorming* and creating a *baseline* of the material, searching for references, and troubleshooting `quarto` and `git` code. I take full responsibility for the substance and presentation of these slides.
:::
