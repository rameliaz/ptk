...
# Tidak ada satu resep baku {background-color="#14497F" .center}

## Banyak versi, satu logika

::: {.incremental}
* [Kline (1986)](https://psycnet.apa.org/record/1987-97491-000) menyusun tahapannya sendiri. Azwar (2019) punya urutan yang sedikit berbeda. [Downing (2006)](https://fatihegitim.wordpress.com/wp-content/uploads/2014/03/hndb-t-devt.pdf), dalam *Handbook of Test Development*, merinci **dua belas langkah** untuk pengujian berskala besar.
...
::: {.incremental}
10. **Penyusunan norma** — mengubah skor mentah menjadi skor yang bisa dimaknai (persentil, skor standar) relatif terhadap kelompok acuan.
...
# Sifat iteratif proses {background-color="#14497F" .center}
...
![](libs/penyusunan_tes.png){fig-align="center"}
...
::: {.incremental}
1. Menulis item tanpa definisi konstrak dan *blueprint* terlebih dahulu adalah kesalahan umum yang berisiko menghasilkan proporsi domain yang tidak sesuai rencana.
